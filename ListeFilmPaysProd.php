...
include 'conect.php';
 ...
 $paysprod=$_POST['paysprod'];
 ?>
<html>
<head>
	<title>Liste des Film produit au/en <?php echo $paysprod ?></title>
...
<tbody>
<?php
$sql="select `CodeFilm`,`NomFilm`,`Synopsis`,`AnneeSortie`,`NomGenre`,`NomLangueVO`, `NomPaysProd` from film, genre, languevo, paysprod where film.CodeGenre = genre.CodeGenre and film.CodePaysProd = paysprod.CodePaysProd and film.CodeLangueVO = languevo.CodeLangueVO and paysprod.NomPaysProd='$paysprod'";
